...
public class OnlineIndexManager {
    ...
    public ResultBeatmap[] searchDatabase(String queryString) throws DebuggableException{
    ...
    public boolean startIndexing() throws DebuggableException{
        return startIndexing(new IndexingProgressAdapter());
    }
    
    private ResultBeatmap[] doMapSearch(IndexingProgressHandler handler, int lastIndexed, String url) throws DebuggableException{
